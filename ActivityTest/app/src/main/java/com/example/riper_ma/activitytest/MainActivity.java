package com.example.riper_ma.activitytest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText textToSecond = (EditText)findViewById(R.id.texttosecond);
        ...
        switch (requestCode){
            case 1:
                if(resultCode == RESULT_OK){
                    ...
                    TextView textFromSecond = (TextView)findViewById(R.id.textfromsecond);
